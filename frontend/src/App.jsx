                        ...
                        <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="About me">
                            ...
                            <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
                              <p class="mb-4">
                                ...
                                I’m eager to contribute to cutting-edge wireless and networking projects 
                                through hands-on engineering, research, and collaboration.
                              </p>
                            </div>
                        </section>
                              ...
                              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:group-hover">
                                ...
                                <div className="z-10 sm:col-span-6">
                                  ...
                                  <h3 className="font-medium leading-snug text-slate-200">
                                    <div>
                                      <a
                                        ...
                                        aria-label="Data Collection & Automation Intern at JAIA (opens in a new tab)"
                                      >
                                  ...
                                  <p className="mt-2 text-sm leading-normal">
                                    Designed and implemented a Python-based data collection pipeline to automate YouTube content 
                                    search, filtering, and audio downloading for AI dataset preparation. Developed API-driven scripts 
                                    to extract, preprocess, and structure audio data used in machine learning workflows.
                                  </p>

                                  <p className="mt-2 text-sm leading-normal">
                                    Collaborated with a research team to maintain dataset integrity, support iterative model 
                                    evaluation, and streamline the data engineering process using Python and open-source tools.
                                  </p>
                                  ...
                                  <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                                    ...
                                    <li className="mr-1.5 mt-2">
                                      <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300">APIs</div>
                                    </li>

                                    <li className="mr-1.5 mt-2">
                                      <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300">Automation</div>
                                    </li>

                                    <li className="mr-1.5 mt-2">
                                      <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300">Data Engineering</div>
                                    </li>
                                  </ul>
                                  ...
                                  <div className="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                      <a 
                                        ...
                                        href="https://github.com/MickoyBanton/Automated-Threat-Hunting"
                                        target="_blank"
                                        rel="noreferrer noopener"
                                        aria-label="AI Intrusion Detection System (opens in new tab)"
                                      >
                                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded 
                                        md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    ...
                                    <p className="mt-2 text-sm leading-normal">
                                      AI-powered system that detects malicious network activity with 93% accuracy using 
                                      Random Forest and reinforcement learning. Includes live packet analysis, anomaly 
                                      detection, and an adaptive training environment using Gymnasium and PyTorch.
                                    </p>
                                  </div>
                                  ...
                                  <div className="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                      <a 
                                        ...
                                        focus-visible:text-teal-300 group/link text-base"
                                        href="#"
                                        aria-label="AI CSEC IT Tutor (opens in a new tab)"
                                      >
                                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded 
                                          md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    ...
                                    <p className="mt-2 text-sm leading-normal">
                                      Designed a full AI-driven learning platform using Node.js, React, MongoDB, Python, and LLMs. 
                                      Built system architecture, REST APIs, user progress tracking, and personalized learning logic. 
                                      Focused on improving educational outcomes using data-driven insights.
                                    </p>
                                  </div>
                                  ...
                                  <div className="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                      <a 
                                        className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 
                                        focus-visible:text-teal-300 group/link text-base"
                                        href="https://github.com/MickoyBanton/OurVLE"
                                        target="_blank"
                                        rel="noreferrer noopener"
                                        aria-label="Course Management System (opens in new tab)"
                                      >
                                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded 
                                          md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                    ...
                                    <p className="mt-2 text-sm leading-normal">
                                      Engineered a full-stack virtual learning environment using ASP.NET, SQL, and React. 
                                      Implemented authentication, course modules, assignments, role-based access control, 
                                      and file management APIs with a normalized relational database schema.
                                    </p>
                                  </div>
